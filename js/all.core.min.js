...
function initTheside(){"use strict";if(TweenMax.to($(".loader2"),.9,{force3D:!0,bottom:"100%",ease:Expo.easeInOut,onComplete:function(){initpageloadAnimation()}}),e=$(".content-holder").data("pagetitle"),$(".horizonral-subtitle strong").text(e),$(".bg").each(function(e){$(this).attr("data-bg")&&$(this).css("background-image","url("+$(this).data("bg")+")")}),$.fn.duplicate=function(e,t){for(var i=[],a=0;a<e;a++)$.merge(i,this.clone(t).get());return this.pushStack(i)},$("<div class='container full-height'></div>").appendTo(".sec-lines"),$("<div class='line-item'></div>").duplicate(5).appendTo(".sec-lines .container"),$(".multi-slideshow_1").length>0){var e,t,i,a,o=new Swiper(".multi-slideshow_1 .swiper-container",{preloadImages:!1,loop:!0,speed:1400,spaceBetween:0,effect:"slide",autoplay:{delay:2500,disableOnInteraction:!1}}),n=new Swiper(".multi-slideshow_2 .swiper-container",{preloadImages:!1,loop:!0,speed:1400,spaceBetween:0,direction:"vertical",effect:"slide"}),r=new Swiper(".multi-slideshow_3 .swiper-container",{preloadImages:!1,loop:!0,speed:1400,spaceBetween:0,effect:"slide"});o.controller.control=n,n.controller.control=o,n.controller.control=r,r.controller.control=n}if($(".multi-slideshow_fs").length>0)var o=new Swiper(".multi-slideshow_fs .swiper-container",{preloadImages:!1,loop:!0,speed:1400,spaceBetween:0,effect:"fade",autoplay:{delay:2500,disableOnInteraction:!1}});if($(".home-half-slider").length>0){var s=new Swiper(".fs-gallery-wrap .swiper-container",{preloadImages:!1,loop:!0,grabCursor:!0,centeredSlides:!1,resistance:!0,resistanceRatio:.6,speed:1400,spaceBetween:0,parallax:!1,effect:"slide",mousewheel:!0,pagination:{el:".hero-slider-wrap_pagination",clickable:!0},autoplay:{delay:3e3,disableOnInteraction:!1},navigation:{nextEl:".hero-slider-button-next",prevEl:".hero-slider-button-prev"}});$(".half-hero-wrap").on({mouseenter:function(){s.autoplay.stop()},mouseleave:function(){s.autoplay.start()}}),s.on("slideChange",function(){var e=s.realIndex+1,t=$("#current");TweenMax.to(t,.2,{force3D:!0,y:-10,opacity:0,ease:Power2.easeOut,onComplete:function(){TweenMax.to(t,.1,{force3D:!0,y:10}),t.html("0"+e)}}),TweenMax.to(t,.2,{force3D:!0,y:0,delay:.3,opacity:1,ease:Power2.easeOut})}),d(),s.on("slideChangeTransitionStart",function(){u()}),s.on("slideChangeTransitionEnd",function(){d()});var l=$(".fs-gallery-wrap .swiper-slide:not(.swiper-slide-duplicate)").length;$("#total").html("0"+l);var c=new Swiper(".hero-slider-img .swiper-container",{preloadImages:!1,loop:!0,resistance:!0,direction:"vertical",spaceBetween:10,init:!0,effect:"slide"});s.controller.control=c,c.controller.control=s}function d(){$(".slide-progress").css({width:"100%",transition:"width 3000ms"})}function u(){$(".slide-progress").css({width:0,transition:"width 0s"})}if($(".fs-slider").length>0){var p=$(".fs-slider").data("mousecontrol2");new Swiper(".fs-slider .swiper-container",{preloadImages:!1,loop:!0,grabCursor:!0,speed:1400,spaceBetween:0,effect:"slide",mousewheel:p,pagination:{el:".hero-slider-wrap_pagination",clickable:!0},navigation:{nextEl:".hero-slider-button-next",prevEl:".hero-slider-button-prev"}})}if($(".fw-carousel").length>0){var h=$(".fw-carousel .swiper-slide").length,f=$(".fw-carousel").data("mousecontrol");new Swiper(".fw-carousel .swiper-container",{preloadImages:!1,loop:!1,freeMode:!0,slidesPerView:"auto",spaceBetween:0,grabCursor:!0,mousewheel:f,speed:1400,scrollbar:{el:".hs_init",draggable:!0},effect:"slide",pagination:{el:".fw-carousel-counter",type:"fraction",renderFraction:function(e){return'<span class="'+e+'"></span>  / <span class="j2total">'+h+"</span>"}},navigation:{nextEl:".fw-carousel-button-next",prevEl:".fw-carousel-button-prev"}})}if($(".grid-carousel ").length>0){var h=$(".grid-carousel .swiper-slide").length,g=new Swiper(".grid-carousel .swiper-container",{preloadImages:!1,loop:!0,freeMode:!1,slidesPerView:3,spaceBetween:0,grabCursor:!0,mousewheel:!0,speed:1400,effect:"slide",autoplay:{delay:3e3},pagination:{el:".fw-carousel-counter",type:"fraction",renderFraction:function(e){return'<span class="'+e+'"></span>  / <span class="j2total">'+h+"</span>"}},navigation:{nextEl:".fw-carousel-button-next",prevEl:".fw-carousel-button-prev"},breakpoints:{768:{slidesPerView:2},640:{slidesPerView:1}}});d(),g.on("slideChangeTransitionStart",function(){u()}),g.on("slideChangeTransitionEnd",function(){d()}),$(".play-pause_carousel").on("click",function(){$(".play-pause_carousel").hasClass("car_stop")?($(".play-pause_carousel").removeClass("car_stop"),g.autoplay.stop()):(g.autoplay.start(),$(".play-pause_carousel").addClass("car_stop"))})}function m(){if($("#portfolio_horizontal_container").length){var e=$("#portfolio_horizontal_container");e.imagesLoaded(function(){778>$(window).width()?(e.isotope({itemSelector:".portfolio_item",layoutMode:"packery",packery:{isHorizontal:!1,gutter:0},resizable:!0,transformsEnabled:!0,transitionDuration:"700ms"}),e.isotope("layout"),e.removeAttr("style"),$(".horizontal-grid-wrap").getNiceScroll().remove()):(e.isotope({itemSelector:".portfolio_item",layoutMode:"packery",packery:{isHorizontal:!0,gutter:0},resizable:!0,transformsEnabled:!0,transitionDuration:"700ms"}),e.isotope("layout"),$(".horizontal-grid-wrap").niceScroll({cursorwidth:"0px",cursorborder:"none",cursorborderradius:"0px",touchbehavior:!0,bouncescroll:!1,scrollspeed:120,mousescrollstep:90,grabcursorenabled:!0,horizrailenabled:!0,preservenativescrolling:!0,cursordragontouch:!0})),$(".gallery-filters").on("click","a",function(t){t.preventDefault();var i=$(this).attr("data-filter");$(".horizontal-grid-wrap").animate({scrollLeft:2},500),setTimeout(function(){e.isotope({filter:i})},900),$(".gallery-filters a").removeClass("gallery-filter-active"),$(this).addClass("gallery-filter-active")}),e.isotope("on","layoutComplete",function(e,t){var t=e.length,i=$(".num-album");TweenMax.to(i,.2,{force3D:!0,y:-10,opacity:0,ease:Power2.easeOut,onComplete:function(){TweenMax.to(i,.1,{force3D:!0,y:10}),i.html(t)}}),TweenMax.to(i,.2,{force3D:!0,y:0,delay:.3,opacity:1,ease:Power2.easeOut})});var t=$(".portfolio_item").length;$(".all-album , .num-album").html(t)})}}$(".testilider").length>0&&new Swiper(".testilider .swiper-container",{preloadImages:!1,slidesPerView:2,spaceBetween:20,loop:!0,grabCursor:!0,mousewheel:!1,pagination:{el:".tc-pagination",clickable:!0},navigation:{nextEl:".ss-slider-next",prevEl:".ss-slider-prev"},breakpoints:{640:{slidesPerView:1}}}),$(".single-slider").length>0&&new Swiper(".single-slider .swiper-container",{preloadImages:!1,slidesPerView:1,spaceBetween:0,loop:!0,autoHeight:!0,grabCursor:!0,mousewheel:!1,pagination:{el:".ss-slider-pagination",clickable:!0},navigation:{nextEl:".ss-slider-cont-next",prevEl:".ss-slider-cont-prev"}}),m(),$(".hor-mob-filter_btn").on("click",function(){778>$(window).width()&&$(".hor-mob-filter .gallery-filters").slideToggle(100)}),!function e(){if($(".gallery-items").length){var t=$(".gallery-items").isotope({singleMode:!0,columnWidth:".grid-sizer, .grid-sizer-second, .grid-sizer-three",itemSelector:".gallery-item, .gallery-item-second, .gallery-item-three",resizable:!0,transformsEnabled:!0,transitionDuration:"700ms"});t.imagesLoaded(function(){t.isotope("layout")}),$(".gallery-filters").on("click","a.gallery-filter",function(e){e.preventDefault();var i=$(this).attr("data-filter");t.isotope({filter:i}),$(".gallery-filters a").removeClass("gallery-filter-active"),$(this).addClass("gallery-filter-active")}),t.isotope("on","layoutComplete",function(e,t){var t=e.length,i=$(".num-album");TweenMax.to(i,.2,{force3D:!0,y:-10,opacity:0,ease:Power2.easeOut,onComplete:function(){TweenMax.to(i,.1,{force3D:!0,y:10}),i.html(t)}}),TweenMax.to(i,.2,{force3D:!0,y:0,delay:.3,opacity:1,ease:Power2.easeOut})});var i=$(".gallery-item").length;$(".all-album , .num-album").html(i)}}(),$(".image-popup").lightGallery({selector:"this",cssEasing:"cubic-bezier(0.25, 0, 0.25, 1)",download:!1,counter:!1});var v=$(".lightgallery");v.data("looped"),v.lightGallery({selector:".lightgallery a.popup-image",cssEasing:"cubic-bezier(0.25, 0, 0.25, 1)",download:!1,loop:!1,counter:!1}),$(".accordion a.toggle").on("click",function(e){e.preventDefault(),$(".accordion a.toggle").removeClass("act-accordion"),$(this).addClass("act-accordion"),$(this).next("div.accordion-inner").is(":visible")?$(this).next("div.accordion-inner").slideUp():($(".accordion a.toggle").next("div.accordion-inner").slideUp(),$(this).next("div.accordion-inner").slideToggle())}),$(".stats").appear(function(){$(".num").countTo()}),$(".skillbar-box").appear(function(){$(this).find("div.skillbar-bg").each(function(){$(this).find(".custom-skillbar").delay(600).animate({width:$(this).attr("data-percent")},1500)})}),$(".tabs-menu").lavaLamp({fx:"easeInOutQuint",speed:600,returnDelay:300,autoReturn:!0}),$(".tabs-menu a").on("click",function(e){var t=$(".tc_item"),i=$(this).data("tabnum");TweenMax.to(t,.4,{force3D:!0,y:-20,opacity:0,ease:Power2.easeOut,onComplete:function(){TweenMax.to(t,.2,{force3D:!0,y:50}),t.html(i)}}),TweenMax.to(t,.4,{force3D:!0,y:0,delay:.5,opacity:1,ease:Power2.easeOut}),e.preventDefault();var a=$(this).attr("href");$(".tab-content").not(a).css("display","none"),$(a).fadeIn()}),$(".share-container").share({networks:["facebook","pinterest","googleplus","twitter","linkedin"]});var w=$(".share-container"),b=$(".share-wrapper"),_=$(".close-share-btn"),y=$(".share-icon"),x=$(".showshare");function k(){x.removeClass("uncl-share"),w.addClass("isShare"),TweenMax.to($(".share-icon"),1,{force3D:!1,opacity:"0"}),TweenMax.to(_,.4,{force3D:!0,top:"-60px",opacity:"0",onComplete:function(){TweenMax.to(b,.6,{force3D:!1,delay:.2,width:"0",ease:Expo.easeInOut})}})}_.on("click",function(){k()}),x.on("click",function(){$(".share-container").hasClass("isShare")?(x.addClass("uncl-share"),w.removeClass("isShare"),TweenMax.to(b,.6,{force3D:!1,width:"350px",ease:Expo.easeInOut,onComplete:function(){TweenMax.to(_,.4,{force3D:!0,top:"0",opacity:"1"}),y.each(function(e){var t=$(this);setTimeout(function(){TweenMax.to(t,1,{force3D:!1,opacity:"1"})},130*e)})}})):k()}),$("#contactform").submit(function(){var e=$(this).attr("action");return $("#message").slideUp(750,function(){$("#message").hide(),$("#submit").attr("disabled","disabled"),$.post(e,{name:$("#name").val(),email:$("#email").val(),phone:$("#phone").val(),subject:$("#subject").val(),comments:$("#comments").val(),verify:$("#verify").val()},function(e){document.getElementById("message").innerHTML=e,$("#message").slideDown("slow"),$("#submit").removeAttr("disabled"),null!=e.match("success")&&$("#contactform").slideDown("slow")})}),!1}),$("#contactform input, #contactform textarea").keyup(function(){$("#message").slideUp(1500)}),$(".chosen-select").selectbox(),$("#subscribe").ajaxChimp({language:"eng",url:"https://gmail.us1.list-manage.com/subscribe/post?u=1fe818378d5c129b210719d80&amp;id=a2792f681b"}),$.ajaxChimp.translations.eng={submit:"Submitting...",0:'<i class="fa fa-check"></i> We will be in touch soon!',1:'<i class="fa fa-warning"></i> You must enter a valid e-mail address.',2:'<i class="fa fa-warning"></i> E-mail address is not valid.',3:'<i class="fa fa-warning"></i> E-mail address is not valid.',4:'<i class="fa fa-warning"></i> E-mail address is not valid.',5:'<i class="fa fa-warning"></i> E-mail address is not valid.'},t=$(".background-youtube-wrapper").data("vid"),i=$(".background-youtube-wrapper").data("mv"),$(".background-youtube-wrapper").YTPlayer({fitToBackground:!0,videoId:t,pauseOnScroll:!0,mute:i,callback:function(){$(".background-youtube-wrapper").data("ytPlayer").player}}),a=$(".background-vimeo").data("vim"),$(".background-vimeo").append('<iframe src="//player.vimeo.com/video/'+a+'?background=1"  frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen ></iframe>'),$(".video-holder").height($(".media-container").height()),$(window).width()>1024?$(".video-holder").length>0&&($(".media-container").height()/9*16>$(".media-container").width()?($(".background-vimeo iframe ").height($(".media-container").height()).width($(".media-container").height()/9*16),$(".background-vimeo iframe ").css({"margin-left":-1*$("iframe").width()/2+"px","margin-top":"0px"})):($(".background-vimeo iframe ").width($(window).width()).height($(window).width()/16*9),$(".background-vimeo iframe ").css({"margin-left":-1*$("iframe").width()/2+"px","margin-top":-1*$("iframe").height()/2+"px",top:"50%"}))):($(window).width(),$(".video-holder").height($(".media-container").height()),$(".background-vimeo iframe ").height($(".media-container").height())),$(".video-container").css("width",$(window).width()+"px"),$(".video-container").css("height",Number(.5625*$(window).width())+"px"),$(".video-container").height()<$(window).height()&&($(".video-container").css("height",$(window).height()+"px"),$(".video-container").css("width",Number(1280/720*$(window).height())+"px")),$(".custom-scroll-link").on("click",function(){var e=$(".main-header").height();if(location.pathname.replace(/^\//,"")===this.pathname.replace(/^\//,"")||location.hostname===this.hostname){var t=$(this.hash);if((t=t.length?t:$("[name="+this.hash.slice(1)+"]")).length)return $("html,body").animate({scrollTop:t.offset().top-e},{queue:!1,duration:1200,easing:"easeInOutExpo"}),!1}}),$(".to-top").on("click",function(e){return e.preventDefault(),$("html, body").animate({scrollTop:0},800),!1});var C=$(window);function D(){$(".height-emulator").css({height:$(".fixed-footer").outerHeight(!0)}),$(".slideshow-container .slideshow-item").css({height:$(".slideshow-container").outerHeight(!0)}),$(".half-slider-item").css({height:$(".half-slider-wrap").outerHeight(!0)}),$(".fs-slider-item").css({height:$(".fs-slider-wrap").outerHeight(!0)}),$(".ms_item").css({height:$(".multi-slideshow_1").outerHeight(!0)}),$(".ms_item2").css({height:$(".multi-slideshow_2").outerHeight(!0)}),$(".ms_item3").css({height:$(".multi-slideshow_3").outerHeight(!0)}),$(".ms-item_fs").css({height:$(".multi-slideshow_fs").outerHeight(!0)}),$(".half-slider-img-item").css({height:$(".half-slider-img").outerHeight(!0)}),$(".horizontal-grid-wrap").css({height:$(".content-holder").outerHeight(!0)-62+"px"}),$(".fixed-column-wrap").css({height:C.outerHeight(!0)-90+"px"}),$(" #portfolio_horizontal_container .portfolio_item img  ").css({height:$(".portfolio_item").outerHeight(!0)})}C.on("scroll",function(e){var e=$(document).height(),t=$(window).height(),i=$(window).scrollTop()/(e-t)*100;$(".progress-bar").css({width:i+"%"})}),D(),C.on("resize",function(){D(),m()});var O=$(".fixed-column-top");O.on("click",function(){$("html, body").animate({scrollTop:$("#tabs-container").offset().top-200+"px"},1200)}),$(".fixed-column").scrollToFixed({minWidth:1064,zIndex:12,marginTop:120,removeOffsets:!0,limit:function(){return $(".limit-box").offset().top-$(".fixed-column").outerHeight(!0)},preFixed:function(){TweenMax.to(O,.6,{force3D:!1,right:"0",ease:Expo.easeInOut})},postFixed:function(){TweenMax.to(O,.6,{force3D:!1,right:"-40px",ease:Expo.easeInOut})},preAbsolute:function(){TweenMax.to(O,.6,{force3D:!1,right:"0",ease:Expo.easeInOut})}}),$(".fixed-column-wrap").scrollToFixed({minWidth:1064,zIndex:12,marginTop:90,removeOffsets:!0,limit:function(){return $(".limit-box").offset().top-$(".fixed-column-wrap").outerHeight(!0)}}),$(".top_fix-filter").scrollToFixed({minWidth:1064,zIndex:12,marginTop:90,removeOffsets:!0,limit:function(){return $(".limit-box").offset().top-$(".top_fix-filter").outerHeight(!0)}});var I={x:0,y:0},T={x:0,y:0},z=document.querySelector(".element");if(TweenLite.set(z,{xPercent:-50,yPercent:-50}),document.addEventListener("mousemove",function e(t){var i=window.pageYOffset||document.documentElement.scrollTop;I.x=t.pageX,I.y=t.pageY-i}),TweenMax.ticker.addEventListener("tick",function e(){T.x+=(I.x-T.x)*.15,T.y+=(I.y-T.y)*.15,TweenMax.set(z,{x:T.x,y:T.y})}),$("#map-single").length>0){var E=$("#map-single").data("latlog"),S=$("#map-single").data("popuptext"),A=L.map("map-single").setView(E,15);L.tileLayer("https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'}).addTo(A);var P=L.icon({iconUrl:"images/marker.png",iconSize:[40,40],popupAnchor:[0,-26]});L.marker(E,{icon:P}).addTo(A).bindPopup(S).openPopup()}$("#menu").menu(),$(".sliding-menu li a.nav").parent("li").addClass("submen-dec"),$(".nav-scroll-bar-wrap").niceScroll({cursorwidth:"0px",cursorborder:"none",cursorborderradius:"0px"});var B=$(".nav-button"),H=$(".nav-holder"),F=$(".nav-overlay");function R(){TweenMax.to(H,.6,{force3D:!1,right:"-500px",ease:Expo.easeInOut}),H.addClass("but-hol"),B.removeClass("cmenu"),F.fadeOut(500)}B.on("click",function(){H.hasClass("but-hol")?(F.fadeIn(500),TweenMax.to(H,.6,{force3D:!1,right:"0",ease:Expo.easeInOut}),H.removeClass("but-hol"),B.addClass("cmenu")):R()}),F.on("click",function(){R()});var M=$(".mm-parallax"),q="",V=navigator.userAgent;V.indexOf("Chrome")>-1||V.indexOf("Safari")>-1?q="-webkit-":V.indexOf("Opera")>-1?q="-o":V.indexOf("Firefox")>-1?q="-moz-":V.indexOf("MSIE")>-1&&(q="-ms-"),$(window).mousemove(function(e){var t=Math.ceil(window.innerWidth/1.5),i=Math.ceil(window.innerHeight/1.5),a=e.pageX-t,o=(e.pageY-i)/i,n=-(a/t);M.css(q+"transform","rotate3d("+o+", "+n+", 0, "+10*Math.sqrt(Math.pow(o,2)+Math.pow(n,2))+"deg)")})}function initparallax(){var e={Android:function(){return navigator.userAgent.match(/Android/i)},BlackBerry:function(){return navigator.userAgent.match(/BlackBerry/i)},iOS:function(){return navigator.userAgent.match(/iPhone|iPad|iPod/i)},Opera:function(){return navigator.userAgent.match(/Opera Mini/i)},Windows:function(){return navigator.userAgent.match(/IEMobile/i)},any:function(){return e.Android()||e.BlackBerry()||e.iOS()||e.Opera()||e.Windows()}};if(null===(trueMobile=e.any())){var t=new Scrollax;t.reload(),t.init(),window.requestAnimationFrame=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||function(e){window.setTimeout(e,1e3/60)},window.cancelAnimationFrame=window.cancelAnimationFrame||window.webkitCancelAnimationFrame||window.mozCancelAnimationFrame||function(e){window.clearTimeout(e)},({init:function(){$("[data-dots]").each(function(){var e=$(this);e[0];var t=$("<canvas/>").appendTo(e)[0],i=e.width(),a=e.height(),o=t.getContext("2d");o.width=i,o.height=a;var n,r=(window.devicePixelRatio||1)/(o.webkitBackingStorePixelRatio||o.mozBackingStorePixelRatio||o.msBackingStorePixelRatio||o.oBackingStorePixelRatio||o.backingStorePixelRatio||1);t.width=i*r,t.height=a*r,o.scale(r,r);var s=void 0,l=void 0;function c(e,t){this.x=e,this.y=t,this.distance=10,this.radians=0,this.draw=function(){o.beginPath(),o.strokeStyle="rgba(151, 151, 151, .3)",o.moveTo(this.x+3,this.y),o.lineTo(this.x+3,this.y+6),o.moveTo(this.x,this.y+3),o.lineTo(this.x+6,this.y+3),o.stroke()},this.update=function(){if(s>-1){var i=(l-t)/(s-e),a=Math.atan(i);s<e&&(a=Math.PI-Math.atan(-i)),this.x=e+Math.cos(a)*this.distance,this.y=t+Math.sin(a)*this.distance}this.draw()}}for(var d=[],u=Math.floor(i/40),p=Math.floor(a/40),h=0;h<p;h++)for(var f=0;f<u;f++){var g=40*f,m=40*h;d.push(new c(g,m))}var v=function(){o.clearRect(0,0,o.width,o.height);for(var e=0;e<d.length;e++)d[e].update()};document.addEventListener("mousemove",function(e){var i=$(t).parent().offset(),a=e.pageX-i.left,n=e.pageY-i.top;s=a,l=n,o.clearRect(0,0,o.width,o.height);for(var r=0;r<d.length;r++)d[r].update();v()}),v()})}}).init()}trueMobile&&$(".bgvid , .background-vimeo , .background-youtube-wrapper  , .gallery__dots").remove()}function initpageloadAnimation(){TweenMax.to($(".pr-bg"),.6,{force3D:!0,left:"100%",ease:Expo.easeInOut}),setTimeout(function(){$(".bot-element").each(function(e){var t=$(this);$(".hlaf-slider-pag .swiper-pagination-bullet"),setTimeout(function(){TweenMax.to(t,1.2,{force3D:!0,bottom:"0",ease:Expo.easeInOut})},230*e)}),$(".hlaf-slider-pag .swiper-pagination-bullet").each(function(e){var t=$(this);setTimeout(function(){TweenMax.to(t,.8,{force3D:!0,opacity:"1",top:"0",ease:Expo.easeInOut})},130*e)}),TweenMax.to($(".scroll-nav-wrap"),.8,{force3D:!0,delay:.3,left:"0",ease:Expo.easeInOut}),TweenMax.to($(".first-tile_load"),1.2,{force3D:!0,delay:.4,y:0,opacity:"1",ease:Power2.easeOut})},400)}function contentAnimShow(){TweenMax.to($(".horizonral-subtitle strong"),.9,{force3D:!0,y:-100,opacity:0,delay:.7,ease:Power2.easeOut,onComplete:function(){TweenMax.to($(".horizonral-subtitle strong"),.1,{force3D:!0,y:100})}}),$(".lg-backdrop , .lg-outer").remove(),$(".nav-button").removeClass("cmenu"),$(".showshare").removeClass("uncl-share"),$(".page-load").fadeIn(1),TweenMax.to($(".page-load_bg2"),.8,{force3D:!0,right:"0",ease:Expo.easeInOut}),TweenMax.to($(".page-load_bg"),.9,{force3D:!0,right:"0",delay:.1,ease:Expo.easeInOut}),setTimeout(function(){$("html, body").animate({scrollTop:0},{queue:!0,duration:10})},1e3)}function contentAnimHide(){var e=$(".content-holder").data("pagetitle");$(".horizonral-subtitle strong").text(e),TweenMax.to($(".horizonral-subtitle strong"),.9,{force3D:!0,y:0,opacity:1,delay:.8,ease:Power2.easeOut}),setTimeout(function(){initpageloadAnimation()},1e3),TweenMax.to($(".page-load_bg"),.8,{force3D:!0,left:"100%",ease:Expo.easeInOut}),TweenMax.to($(".page-load_bg2"),.9,{force3D:!0,left:"100%",delay:.1,ease:Expo.easeInOut,onComplete:function(){setTimeout(function(){$(".page-load").fadeOut(1),TweenMax.to($(".page-load_bg2 , .page-load_bg"),0,{force3D:!0,left:"0",right:"100%"})},10)}})}function readyFunctions(){initTheside(),initparallax()}$("<div class='page-load'><div class='page-load_bg'><div class='loader loader_each'><span></span></div></div><div class='page-load_bg2'></div></div>").appendTo("#main"),$(function(){$.coretemp({reloadbox:"#wrapper",outDuration:700,inDuration:200}),readyFunctions(),$(document).on({ksctbCallback:function(){readyFunctions()}})}),document.addEventListener("gesturestart",function(e){e.preventDefault()});
