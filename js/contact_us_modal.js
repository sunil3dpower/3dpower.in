    ...
    $(document).ready(function() {
        $("#submitBtn").click(function(event) {
            ...
            if (captchaResponse === "") {
                ...
                $("#submitBtn").prop("disabled", false).html('Send Message <i class="fal fa fa-long-arrow-right"></i>');
                return;
            }
  ...
  recaptcha.setAttribute("data-theme", "dark");
    ...
    fileNameDisplay.textContent = fileName.length > 24 ? fileName.substring(0, 24) + "..." : fileName;
    label.innerHTML = '';
