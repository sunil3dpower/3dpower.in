...
function initTheside() {
	...
	firstLoad();
function firstLoad() {
var loaderComplete = false;

// Ensure loader animation completes within 1 second
setTimeout(function() {
	if (!loaderComplete) {
		completeLoader();
	}
...
TweenMax.to($(".loader2"), 0.5, { // Reduced animation time to 0.5 seconds
	force3D: true,
	bottom: "100%",
	ease: Expo.easeInOut,
	onComplete: function() {
...
function completeLoader() {
	initpageloadAnimation(); // This function starts after loader completes
